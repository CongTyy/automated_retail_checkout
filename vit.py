...
from ViT.hugsvision.inference.VisionClassifierInference import VisionClassifierInference
...
classifier = VisionClassifierInference(
            feature_extractor = DeiTFeatureExtractor.from_pretrained('./ViT/out/KVASIR_V2/5_2022-03-24-00-14-23/model'),
            model = DeiTForImageClassification.from_pretrained('./ViT/out/KVASIR_V2/5_2022-03-24-00-14-23/model'),
        )
def inference(img):
    # try:
