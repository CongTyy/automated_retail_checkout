...
class BaseModel(nn.Module):
    ...
    def forward(self, x, profile=False, visualize=False, gan = False, full = False):
        """
        ...
        """
        return self._forward_once(x, profile, visualize, gan, full)

    def _forward_once(self, x, profile=False, visualize=False, gan = False, full = False):
        """
...
class DetectionModel(BaseModel):
    ...
    def forward(self, x, augment=False, profile=False, visualize=False, gan = False, full = False):
        if augment:
            return self._forward_augment(x, gan = gan, full = full)  # augmented inference, None
        return self._forward_once(x, profile, visualize, gan, full = full)  # single-scale inference, train
